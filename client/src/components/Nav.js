                        ...
                        {!currentUser ?
                            <div className="mx-auto order-1">
                                <button className="btn btn-outline-secondary" data-bs-toggle="modal"
                                        data-bs-target="#loginModal" id="login-button">Log in
                                </button>
                                <button className="btn btn-primary" data-bs-toggle="modal"
                                        data-bs-target="#registerModal" id="register-button">Sign up
                                </button>
                            ...
                            : <div className="mx-auto order-1">
                                <button className="btn btn-outline-secondary btn-link" id="logout-button"
